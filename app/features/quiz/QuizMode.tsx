...
export function QuizMode({ gameState, setGameState, resetToHome, t }: QuizModeProps) {
  ...
  return (
    <div className="safe-bottom w-full h-full min-h-0 flex flex-col items-center justify-start sm:justify-center p-2 overflow-y-auto custom-scroll">
      <AnimatePresence mode="wait">
        ...
        {quizGameState === "QUIZ_INTRO" && (
          <motion.div
            ...
            className="w-full max-w-2xl bg-white border-2 sm:border-4 border-brand-charcoal rounded-card shadow-elevated p-4 sm:p-6 md:p-8 text-center flex flex-col items-center gap-4 sm:gap-6"
          >
        ...
        {(quizGameState === "QUIZ_PLAYING" || quizGameState === "QUIZ_FEEDBACK") && currentQuizQuestion && (
          <motion.div
            ...
            className="w-full max-w-[720px] bg-white border-2 sm:border-4 border-brand-charcoal rounded-card shadow-elevated overflow-visible sm:overflow-hidden flex flex-col relative shrink-0"
          >
            ...
            {/* Active Core Area */}
            <div className="p-4 sm:p-6 md:p-8 flex-1 flex flex-col justify-between gap-4 sm:gap-6">
              {/* Question Card */}
