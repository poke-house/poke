        ...
        {isLoading && leaderboard.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-6 px-4 text-center">
            ...
            <div className="flex items-end justify-center gap-2.5 mb-5 w-full max-w-[240px] h-28">
              ...
              {/* 1st place */}
              <div className="flex-1 flex flex-col items-center">
                <div className="w-8 h-8 rounded-full border-2 border-dashed border-indigo-400/80 bg-indigo-50/50 flex items-center justify-center text-xs font-bold text-indigo-600 mb-1.5 font-mono">
                  {translations?.language === 'en' || translations?.house_arena_ranking_retry === 'Try Again' ? '1st' : '1º'}
                </div>
                <div className="w-full h-20 rounded-t-lg border-2 border-b-0 border-dashed border-indigo-400/60 bg-indigo-50/30 flex items-center justify-center">
