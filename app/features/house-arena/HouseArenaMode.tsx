...
const StartingScreen: React.FC<{ language: 'pt' | 'en' }> = ({ language }) => {
  return (
    <div className="bg-brand-linen min-h-full w-full flex items-center justify-center font-sans px-4 safe-bottom">
...
const ActiveRoundScreen: React.FC<{
  ...
  return (
    <div className="bg-brand-linen min-h-full w-full flex items-center justify-center font-sans px-4 py-4 sm:py-8 safe-bottom">
...
export const HouseArenaMode: React.FC<HouseArenaModeProps> = ({
  ...
  if (isLoading && !activeRoom) {
    return (
      <div className="bg-brand-linen min-h-full w-full flex items-center justify-center font-sans safe-bottom">
  ...
  if (activeRoom) {
    if (activeRoom.status === 'lobby') {
      return (
        <div className="bg-brand-linen min-h-full w-full flex flex-col justify-start py-4 sm:py-8 safe-bottom overflow-y-auto">
          <ArenaLobby
            room={activeRoom}
    ...
    if (activeRoom.status === 'active') {
      if (activeRoom.currentGameType === 'slop_clock') {
        ...
        return (
          <div className="bg-brand-linen min-h-full w-full flex flex-col justify-start py-6 sm:py-12 px-4 md:px-8 safe-bottom overflow-y-auto">
            <ArenaRoundResults 
    ...
    if (activeRoom.status === 'results') {
      return (
        <div className="bg-brand-linen min-h-full w-full flex flex-col justify-start py-4 px-2 md:px-4 safe-bottom overflow-y-auto">
          <ArenaFinalResults 
            roomCode={activeRoom.roomCode} 
            reconnectToken={reconnectToken} 
            language={language}
  ...
  return (
    <div className="bg-brand-linen min-h-full w-full flex flex-col justify-start sm:justify-center py-4 sm:py-8 safe-bottom overflow-y-auto">
      <ArenaHome
        onBack={onBack}
