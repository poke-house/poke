...
export const RushMode: React.FC<RushModeProps> = ({
  ...
  return (
    <div className="safe-bottom w-full h-full min-h-0 flex items-start md:items-center justify-center relative p-2 md:p-6 overflow-y-auto custom-scroll" id="rush-mode-container">
      ...
      {rushGameState === "RUSH_SELECT" && (
        <div className="w-full max-w-4xl bg-brand-linen rounded-card shadow-elevated flex flex-col md:flex-row overflow-visible md:overflow-hidden animate-slide-up border-2 sm:border-4 border-brand-charcoal max-h-none md:max-h-[85vh] shrink-0" id="rush-select-screen">
          ...
          <div className="md:w-1/2 p-4 sm:p-6 md:p-8 flex flex-col justify-center overflow-y-auto custom-scroll" id="rush-mode-selection">
