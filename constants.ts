...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
    ...
    { id: 23, question: "Quais são as duas novas Poke Bowls de Inverno?", options: ["Velvet Garden e Cozy Chicken", "Winter Salmon e Spicy Chicken", "Garden Mix e Hot Tuna", "Sweet Potato e Crispy Chicken"] },
    { id: 24, question: "Qual é a porção padrão da Mix Salad?", options: ["1 pinça de salada / 35g", "2 pinças de salada", "1 scoop 1/20", "1 mão cheia"] },
    ...
    { id: 29, question: "Qual a proteína da Lime & Mango Shrimp?", options: ["Camarão c/ Lima e Tomilho", "Camarão Panado", "Salmão Braseado", "Miso Glazed Salmon"] },
...
export const INGREDIENTS_DB: IngredientDB = {
    sizes: ["Regular", "Large"],
    bases: ["180g Arroz de sushi", "270g Arroz de sushi", "150g Arroz de sushi", "200g Arroz de sushi", "250g Arroz de sushi", "300g Arroz de sushi", "Arroz preto", "Quinoa", "Arroz basmati", "Coconut Basmati", "Espinafres", "Mix Salad"],
    sauces_base: ["Azeite", "Azeite + Sal", "Azeite de Limão", "Vinagrete", "Ponzu", "Sriracha Mayo", "Não leva"],
    greens: ["Batata Doce com Alecrim", "Brócolis", "Milho", "Abacaxi", "Edamame", "Tomate Cherry", "Couve roxa", "Courgette", "Cenoura", "Grana Padano", "Pepino", "Feta", "Azeitonas", "Abacate", "Philadelphia", "Wakame", "Manga", "Hummus", "Guacamole", "Cebola Roxa", "Morangos", "Espargos Grelhados"],
    proteins: ["Salmão Braseado", "Miso Glazed Salmon", "Camarão Panado", "Frango", "Frango Teriyaki", "Camarão c/ Lima e Tomilho", "Juicy Salmon", "Juicy Tuna", "Salmão", "Atum", "Tofu Grelhado", "Ovo", "Baked Halloumi", "Não leva", "Wakame"],
...
export const RECIPES: Recipe[] = [
    { id: 1, category: "HOUSE", name: "Sunny Salmon 🌞", variants: { "Regular": { base: ["180g Arroz de sushi"], sauce_base: ["Não leva"], greens: ["Abacate", "Edamame", "Couve roxa"], protein: ["Juicy Salmon", "Juicy Salmon"], sauce_final: ["Ponzu", "Azeite", "Creme de Abacate"], crispy: ["Não leva"], sesame: ["Sim"] }, "Large": { base: ["270g Arroz de sushi"], sauce_base: ["Não leva"], greens: ["Abacate", "Couve roxa", "Couve roxa", "Edamame", "Edamame"], protein: ["Juicy Salmon", "Juicy Salmon", "Juicy Salmon"], sauce_final: ["Ponzu", "Azeite", "Creme de Abacate"], crispy: ["Não leva"], sesame: ["Sim"] } } },
    { id: 2, category: "HOUSE", name: "Spicy Tuna 🐟", variants: { "Regular": { base: ["180g Arroz de sushi"], sauce_base: ["Não leva"], greens: ["Cenoura", "Couve roxa", "Pepino"], protein: ["Atum", "Atum", "Wakame"], sauce_final: ["Spicy Peanuts", "Ponzu"], crispy: ["Cebola Crocante", "Chilli Flakes"], sesame: ["Sim"] }, "Large": { base: ["270g Arroz de sushi"], sauce_base: ["Não leva"], greens: ["Cenoura", "Couve roxa", "Couve roxa", "Pepino", "Pepino"], protein: ["Atum", "Atum", "Atum", "Wakame"], sauce_final: ["Spicy Peanuts", "Ponzu"], crispy: ["Cebola Crocante", "Chilli Flakes"], sesame: ["Sim"] } } },
    { id: 3, category: "HOUSE", name: "Hummus & Avo 🌿", variants: { "Regular": { base: ["Arroz basmati", "Arroz basmati"], sauce_base: ["Não leva"], greens: ["Abacate", "Hummus", "Hummus", "Tomate Cherry", "Pepino", "Azeitonas"], protein: ["Não leva"], sauce_final: ["Manjericão e Hortelã"], crispy: ["Amêndoa"], sesame: ["Não"] }, "Large": { base: ["Arroz basmati", "Arroz basmati", "Arroz basmati"], sauce_base: ["Não leva"], greens: ["Abacate", "Hummus", "Hummus", "Hummus", "Tomate Cherry", "Pepino", "Azeitonas", "Azeitonas"], protein: ["Não leva"], sauce_final: ["Manjericão e Hortelã"], crispy: ["Amêndoa"], sesame: ["Não"] } } },
    ...
    { id: 5, category: "HOUSE", name: "Fire Salmon 🔥", variants: { "Regular": { base: ["180g Arroz de sushi"], sauce_base: ["Sriracha Mayo"], greens: ["Edamame", "Tomate Cherry", "Pepino"], protein: ["Salmão", "Salmão"], sauce_final: ["Sriracha Mayo"], crispy: ["Cebola Crocante", "Chilli Flakes"], sesame: ["Sim"] }, "Large": { base: ["270g Arroz de sushi"], sauce_base: ["Sriracha Mayo"], greens: ["Edamame", "Tomate Cherry", "Pepino", "Pepino"], protein: ["Salmão", "Salmão", "Salmão"], sauce_final: ["Sriracha Mayo"], crispy: ["Cebola Crocante", "Chilli Flakes"], sesame: ["Sim"] } } },
    { id: 6, category: "HOUSE", name: "Mixed Seas 🌊", variants: { "Regular": { base: ["180g Arroz de sushi"], sauce_base: ["Não leva"], greens: ["Cenoura", "Cebola Roxa", "Manga", "Wakame"], protein: ["Atum", "Salmão"], sauce_final: ["Ponzu"], crispy: ["Ervilhas Wasabi"], sesame: ["Sim"] }, "Large": { base: ["270g Arroz de sushi"], sauce_base: ["Não leva"], greens: ["Cenoura", "Cenoura", "Cebola Roxa", "Wakame", "Manga"], protein: ["Atum", "Salmão", "Salmão"], sauce_final: ["Ponzu"], crispy: ["Ervilhas Wasabi"], sesame: ["Sim"] } } },
    ...
    { id: 8, category: "HOUSE", name: "Sushi Bowl 🍣", variants: { "Regular": { base: ["180g Arroz de sushi"], sauce_base: ["Não leva"], greens: ["Abacate", "Edamame", "Philadelphia", "Morangos"], protein: ["Salmão Braseado", "Salmão Braseado"], sauce_final: ["Teriyaki"], crispy: ["Cebola Crocante"], sesame: ["Sim"] }, "Large": { base: ["270g Arroz de sushi"], sauce_base: ["Não leva"], greens: ["Abacate", "Morangos", "Philadelphia", "Edamame", "Edamame"], protein: ["Salmão Braseado", "Salmão Braseado", "Salmão Braseado"], sauce_final: ["Teriyaki"], crispy: ["Cebola Crocante"], sesame: ["Sim"] } } },
    { id: 9, category: "GREEN", name: "The Caesar 🥗", variants: { "Regular": { base: ["Mix Salad", "Mix Salad", "Mix Salad"], sauce_base: ["Vinagrete"], greens: ["Tomate Cherry", "Tomate Cherry", "Grana Padano"], protein: ["Frango", "Frango"], sauce_final: ["Creamy Caesar"], crispy: ["Bacon", "Croutons", "Lima"], sesame: ["Não"] } } },
    { id: 10, category: "GREEN", name: "Exotic Salmon 🥗", variants: { "Regular": { base: ["Coconut Basmati", "Espinafre", "Espinafre"], sauce_base: ["Azeite de Limão"], greens: ["Batata Doce com Alecrim", "Batata Doce com Alecrim", "Brócolis", "Abacate"], protein: ["Miso Glazed Salmon", "Miso Glazed Salmon"], sauce_final: ["Sriracha Mayo"], crispy: ["Não leva"], sesame: ["Não"] } } },
    { id: 11, category: "GREEN", name: "Grilled Halloumi 🥗", variants: { "Regular": { base: ["Mix Salad", "Mix Salad", "Mix Salad"], sauce_base: ["Vinagrete"], greens: ["Espargos Grelhados", "Abacate", "Tomate Cherry", "Azeitonas"], protein: ["Baked Halloumi", "Baked Halloumi"], sauce_final: ["Manjericão e Hortelã"], crispy: ["Nozes com Mel"], sesame: ["Não"] } } },
