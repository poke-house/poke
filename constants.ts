...
export const RECIPES: Recipe[] = [
    ...
    { id: 2, category: "HOUSE", name: "Spicy Tuna 🐟", variants: { "Regular": { base: ["180g Arroz de sushi"], sauce_base: ["Não leva"], greens: ["Cenoura", "Couve roxa", "Pepino"], protein: ["Atum", "Atum", "Wakame"], sauce_final: ["Ponzu", "Spicy Peanuts"], crispy: ["Cebola Crocante", "Chilli Flakes"], sesame: ["Sim"] }, "Large": { base: ["270g Arroz de sushi"], sauce_base: ["Não leva"], greens: ["Cenoura", "Couve roxa", "Couve roxa", "Pepino", "Pepino"], protein: ["Atum", "Atum", "Atum", "Wakame"], sauce_final: ["Ponzu", "Spicy Peanuts"], crispy: ["Cebola Crocante", "Chilli Flakes"], sesame: ["Sim"] } } },
